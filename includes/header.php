  ...
  <nav class="navbar navbar-default navbar-static-top">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <?php if (isset($_SESSION['userId']) && $_SESSION['userId'] == 1) { ?>
              ...
              <li id="navAreas"><a href="areas.php"> <i class="glyphicon glyphicon-home"></i> Áreas</a></li>
            <li id="navSalidas"><a href="salidas.php"> <i class="glyphicon glyphicon-export"></i> Salidas</a></li>        
    <?php } ?>
    ...
    <?php } ?>   
      ...
      <?php if (isset($_SESSION['userId']) && $_SESSION['userId'] == 1) { ?>
                ...
                <li id="topNavUser"><a href="user.php"> <i class="glyphicon glyphicon-wrench"></i> Usuarios</a></li>
<?php } ?>              
