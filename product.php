		...
		<div class="modal-content">
			...
			<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST"
				...
				<div class="modal-body" style="max-height:450px; overflow:auto;">
					...
					<!-- Brand Name removed -->
					<input type="hidden" name="brandName" value="1">
					...
					<div class="tab-content">
						...
						<div role="tabpanel" class="tab-pane" id="productInfo">
							<form class="form-horizontal" id="editProductForm" action="php_action/editProduct.php"
								...
								<!-- edit Rate removed -->
								<input type="hidden" id="editRate" name="editRate" value="0">

								<!-- edit Brand Name removed -->
								<input type="hidden" id="editBrandName" name="editBrandName" value="1">
